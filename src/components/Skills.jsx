        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="relative bg-gradient-to-r from-blue-50 to-purple-50 dark:from-gray-800 dark:to-gray-700 rounded-2xl p-8 text-center shadow-lg">
              ...
              >
                Continuously enhancing my frontend skill set by exploring modern
                web technologies, UI/UX best practices, and industry-standard
                frameworks to build high-quality, user-centric web applications.
              </motion.p>
              <motion.div
          ...
          >
            <div className="relative bg-white/10 dark:bg-gray-800/10 backdrop-blur-xl border border-white/20 dark:border-gray-700/20 rounded-2xl p-8 text-center shadow-2xl overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                >
                  Technology evolves rapidly, and so do I. I continuously
                  explore new frontend frameworks, React libraries, UI/UX
                  techniques, and modern tools to build responsive and
                  user-centric web applications while staying current with
